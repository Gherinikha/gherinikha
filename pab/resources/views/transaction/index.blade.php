<x-app-layout>
 ...
 id="grid-last-name">
 <option @if($periode=='MINGGU') SELECTED @endif
 value="MINGGU">MINGGU TERAKHIR</option>
 <option @if($periode=='BULAN') SELECTED @endif
 value="BULAN">BULAN INI</option>
 <option @if($periode=='TAHUN') SELECTED @endif
 value="TAHUN">TAHUN INI</option>
 <option @if($periode=='SEMUA') SELECTED @endif
 ...
 value="SEMUA">SEMUA</option>
 <option @if($status=='ORDER') SELECTED @endif
 value="ORDER">ORDER</option>
 <option @if($status=='BAYAR') SELECTED @endif
 value="BAYAR">BAYAR</option>
 <option @if($status=='BATAL') SELECTED @endif
